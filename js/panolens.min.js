(function(k, d) {
    ...
    y.prototype = Object.assign(Object.create(d.Sprite.prototype), {
        ...
        onClick: function(a) {
            ...
            console.log(a)
            console.log("click")
            // window.location.href="http://www.ncyu.edu.tw"
        },
        onDismiss: function() {
    ...
    ea.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
        ...
        setupContainer: function(a) {
            ...
            a.style.width = "100%";
            a.style.height = "100%";
            // document.getElementById("VR").appendChild(a);
        ...
        reverseDraggingDirection: function() {
            console.log(this.OrbitControls.rotateSpeed);
            // console.log(this.OrbitControls.momentumScalingFactor);
        ...
        rotateControlLeft: function(a) {
            ...
            // console.log(this.control.rotateLeft(a));
        },
        ...
        onTap: function(a, b) {
            ...
            // this.raycasterPoint.x = new_alpha;
            console.log(this.raycasterPoint.x);
        ...
        render: function() {
            ...
            // console.log(this.sceneReticle);
            // console.log(this.camera);
        },
        animate: function() {
            // console.log("XXXXrequest");
            // console.log(this.requestAnimationId);
